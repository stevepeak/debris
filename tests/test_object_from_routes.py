...
class Tests(unittest.TestCase):
    data = {
        "1":  {"id": "1", "name": "Elaina Dach", "email": "hane.ebba@wolf.com"},
        "2":  {"id": "2", "name": "Lucas Jaskolski", "email": "chad.cummings@hotmail.com"},
        "3":  {"id": "3", "name": "Ms. Agustin Walter", "email": "johnnie.jast@hotmail.com"},
        "4":  {"id": "4", "name": "Mr. Agustina Ward IV", "email": "guiseppe85@metz.info"},
        "5":  {"id": "5", "name": "Dr. Brock Sanford IV", "email": "hilpert.beryl@langworthryan.com"},
        "6":  {"id": "6", "name": "Itzel Schimmel", "email": "myost@hagenesklein.com"},
        "7":  {"id": "7", "name": "Ms. Desiree Simonis", "email": "liliana23@beer.net"},
        "8":  {"id": "8", "name": "Gabe Kling", "email": "jordyn.lynch@yahoo.com"},
        "9":  {"id": "9", "name": "Raheem Kreiger", "email": "lindgren.tanya@yahoo.com"},
        "10": {"id": "10", "name": "Maximilian Kulas", "email": "tomas45@hotmail.com"}
    }
